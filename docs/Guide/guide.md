...
::: tip 介绍
1. 使用了VuePress主题模板[🔥 The 2.x of vuepress-theme-reco.](https://github.com/vuepress-reco/vuepress-theme-reco)；<br>
2. 主题追求极简，根据 VuePress 的默认主题修改而成，官方的主题配置仍然适用；<br>
3. 你可以打开 [午后南杂](http://recoluan.gitlab.io) 来查看效果。<br>
4. ....
:::
...
```JavaScript
1.可打开md文件，启用源代码模式查看md文档各个模块的源代码
```
**引用框代码**
::: tip 代码
tip示例
